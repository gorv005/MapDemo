...
import com.np.mapdemo.aws.S3Uploader;
import com.np.mapdemo.aws.S3Utils;

import java.io.FileNotFoundException;
import java.io.InputStream;

public class ImageU extends AppCompatActivity {
    ...
    private String TAG = ImageU.class.getCanonicalName();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_image_u);
        bindViews();
